...
export const PAGE_META: Record<string, PageMeta> = {
  index: {
    ...
    ogImage:
      "/external/cdn.prod.website-files.com/64cc98fb252732dec5bda7e9/65a66f06e0e919d7d7e3e8d5_setproduct2.webp",
    canonical: "https://www.setproduct.com",
  },
  all: {
    title: "Explore a Wide Range of Figma Templates, Design Systems, and UI Kits",
    description:
  ...
  dashboards: {
    title: "Dashboard Templates & UI Kits. Figma Dashboard Templates - Setproduct",
    description:
  ...
  mobile: {
    title: "Explore Figma Mobile UI kits, Templates and Design Systems",
    description:
  ...
  code: {
    title: "Explore Figma Code UI kits, Libraries, Templates and Design Systems",
    description:
  ...
  dataviz: {
    title: "Explore Figma Chart UI kits, Templates and Design Systems",
    description:
  ...
  websites: {
    title: "Explore Figma Web UI kits, Templates and Design Systems",
    description:
  ...
  bundle: {
    title: "Explore Figma UI kits Bundle, Templates and Design Systems",
    description:
  ...
  blog: {
    title: "UI/UX Design Articles, Career Guides, Tutorials & Startup Growth Insights",
    description:
    ...
    ogImage:
      "/external/cdn.prod.website-files.com/64cc98fb252732dec5bda7e9/67bd71cb3dd87772bfb3281b_image1_(15).webp",
    canonical: "https://www.setproduct.com/blog",
  },
  freebies: {
    title: "Free Figma Templates: UI Design Resources for Web, Mobile & Desktop",
    description:
  ...
  testimonials: {
    title: "Setproduct happy customers. Testimonials and clients feedback",
    description:
