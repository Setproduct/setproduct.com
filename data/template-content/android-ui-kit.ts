export const android_ui_kitContent = {
  "features": [],
  "carousels": [
    {
      "title": "140 templates",
      "subtitle": "Activity, Authentication, Ecommerce, Cart, Cards, Grids, Calendar, Checkout, Content screens, Deals & Offers, Discover, Home, Filters, Product details, Planner, Maps, Side navigation, Profile, Search, Social layouts, Tasks, Wishlist",
  ...
  "pricing": {
    "title": "Get started⚡",
    "subtitle": "Pay once & use forever this well-crafted Figma Android library to design mobile apps 3x faster.",
    "cards": [
      {
