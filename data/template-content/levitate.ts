export const levitateContent = {
  "features": [],
  "video": {
    "url": "https://www.youtube-nocookie.com/embed/9zIXbZ2x2gM",
    "title": "Use Levitate to create cool scenes and get more attention to your product",
    "subtitle": "Variety of 3D items: Gadgets, Geometric items, Financial items, Popular icons, 3D mockups and more categories to be included soon..."
  },
  "carousels": [
    {
    ...
    "cards": [
      {
        ...
        "previewHref": "https://www.figma.com/file/25hBY4vuqRwPRH3uMaGm14/Levitate-(preview)?type=design&amp;mode=design"
      },
      {
