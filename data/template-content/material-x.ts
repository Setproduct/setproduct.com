export const material_xContent = {
  "features": [
    {
  ...
  "video": {
    "url": "https://www.youtube-nocookie.com/embed/9eRp-5DEa8A",
    "title": "Desktop & mobile templates for Material dashboards",
    "subtitle": "Easy to change fonts and swap colors. Modify and reuse the templates to save time and human resources. Suit your mobile or desktop app with Material-X UI kit"
  },
  "carousels": [
    {
  ...
  "pricing": {
    "title": "Get started⚡",
    "subtitle": "Pay once & use forever this well-crafted Figma dashboard library to design web apps 3x faster.",
    "cards": [
      {
