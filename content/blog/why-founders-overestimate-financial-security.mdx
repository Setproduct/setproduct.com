...
![Comparison showing an $80M paper valuation from 20% of a $400M company locked behind illiquid private shares, next to a small circle of accessible cash reduced to salary only, with down round, no buyer, and IPO delay listed as risks](/blog/assets/why-founders-overestimate-financial-security/img-1.webp)
...
![Hub-and-spoke diagram with a single company at the center connected to four dependencies: equity value, future fundraising, personal income, and professional reputation, all enclosed within a dashed circle labeled concentration risk](/blog/assets/why-founders-overestimate-financial-security/img-2.webp)
