---
title: 'Empty state UI design: The screen that loses 80% of users'
description: >-
  Most empty states quietly lose users. Learn the writing, visuals, and CTA
  patterns that turn no-data screens into onboarding wins, backed by UX research.
...
subtitle: >-
  ...
  improve UX outcomes.
metaTitle: 'Empty state UI design: The screen that loses 80% of users'
cardDescription: >-
  Most empty states quietly lose users. Learn the writing, visuals, and CTA
  patterns that turn no-data screens into onboarding wins, backed by UX research.
...
![Empty states are those UI moments when there is no content yet to display](/blog/assets/empty-state-ui-design/img-1.webp)
...
![Why empty states deserve priority](/blog/assets/empty-state-ui-design/img-2.webp)
...
![No search results - Empty State UI design](/blog/assets/empty-state-ui-design/img-3.webp)
...
![Empty saved states (Favorites, bookmarks, likes)](/blog/assets/empty-state-ui-design/img-4.webp)
...
![Empty state offers a clear next step](/blog/assets/empty-state-ui-design/img-5.webp)
...
![Empty state design - your inbox is clear](/blog/assets/empty-state-ui-design/img-6.webp)
...
![Be subtle with humor and illustration when designing Empty State screens](/blog/assets/empty-state-ui-design/img-7.webp)
...
![Writing Empty State human messages](/blog/assets/empty-state-ui-design/img-8.webp)
...
![](/blog/assets/empty-state-ui-design/img-9.webp)
