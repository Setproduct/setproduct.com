...
| Нет фильтра внутри блога | Чипы категорий в табе Blog | Чипы строятся из найденных статей и сортируются по количеству, выбор хранится в `?category=` |
...
- чипы показываются, только когда в выдаче блога больше одной категории
